...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-purple-700/90 to-indigo-700/80 p-12 text-white">
        ...
        <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-white/6 rounded-full blur-3xl" />
        ...
        <div className="w-full max-w-[420px]">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input id="email" type="email" placeholder="anna@gmail.com" value={email} autoComplete="off" onChange={(e) => setEmail(e.target.value)} onFocus={() => setIsTyping(true)} onBlur={() => setIsTyping(false)} required className="h-12 bg-background border-border/60 focus:border-primary" />
            </div>
